...
<script src="{$module_dir}views/js/gen_validatorv4.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="{$module_dir}views/css/priceandorder14.css"/>